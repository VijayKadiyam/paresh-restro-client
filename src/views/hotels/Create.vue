  ...
  <div class="animated fadeIn">
    <div class="container">
      <b-row class="justify-content-center">
        <b-col md="8">
          <b-card
            header="<i class='fa fa-paper-plane'></i>&nbsp;&nbsp;Add New Outlet"
          >
            <!-- Create outlet Form -->
            ...
            >
              ...
              <br>
              <b-button variant="primary" class="px-4" type="submit">Create Outlet</b-button>
            </b-form>
            <!-- End Create Outlet form -->
          </b-card>
        </b-col>
      </b-row>
    </div>
