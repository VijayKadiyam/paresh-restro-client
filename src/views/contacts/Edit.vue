  ...
  <div class="animated fadeIn">
    <div class="container">
      <b-row class="justify-content-center">
        <b-col md="8">
          <b-card
            header="<i class='fa fa-paper-plane'></i>&nbsp;&nbsp;Edit Contact Details"
          >
            <!-- Update Contact Form -->
            ...
            >
              ...
              <br>
              <b-button variant="primary" class="px-4" type="submit">Update Contact</b-button>
            </b-form>
...
export default {
  ...
  mounted () {
    ...
    this.form.get(`/api/contacts/${this.$route.params.contactId}`)
      .then(data => {
  ...
  methods: {
    // To edit a new outlet
    edit () {
      this.form.patch(`/api/contacts/${this.$route.params.contactId}`)
        .then(data => {
